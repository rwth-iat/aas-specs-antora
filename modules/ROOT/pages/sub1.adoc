...
[width="100%",cols="25%,50%,19%,6%",options="header",]
|===
|*idShort:* a|
ModuleTypePackage
...
|*idShort* |*Description@en* |*example* |*card.*
a|
{empty}[File]
...
[width="100%",cols="24%,51%,19%,6%",options="header",]
|===
|*idShort:* a|
...
[width="100%",cols="15%,55%,24%,6%",options="header",]
|===
|*idShort:* |\{arbitrary} | |
|*Class:* |SubmodelElementCollection (SMC) | |
